 ...
 */
var ObjectAssessment = /** @class */ (function (_super) {
    __extends(ObjectAssessment, _super);
    /**
     * @description generate an object with default fields for this type
     *  will copy extra fields from the data passed in
     * @param data - optional
     */
    function ObjectAssessment(data) {
        var _this = _super.call(this, data) || this;
        _this.type = stix_enum_1.StixEnum.OBJECT_ASSESSMENT;
        return _this;
    }
